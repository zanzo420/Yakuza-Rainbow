...
#define OFFSET_ENTITY_PLAYERINFO 0xA8
#define OFFSET_PLAYERINFO_CTU 0x16C
#define OFFSET_PLAYERINFO_OP 0x16D
...
inline int BoneId[100][10][17] = { //[CTU][OP]
	{//head high_neck low_neck r_shoulder l_shoulder r_elbow l_elbow r_hand l_hand high_stomach low_stomach pelvis r_knee l_knee r_foot l_foot
		{0x38,0x34,0x33,0x07,0x58,0x08,0x59,0x09,0xC4,0x05,0x04,0x02,0xAC,0xB6,0xAD,0xB7},//RECRUIT
	...
	{
		{ 0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00 },//empty
		{ 0x36,0x32,0x31,0x07,0x7A,0x08,0x71,0x09,0x73,0x05,0x04,0x02,0x8D,0x95,0x8e,0x96 },//oryx
